...
<section class="section">
  <div class="container">
    ...
    <form enctype="multipart/form-data" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="card-panel">
      ...
      <div class="row">
        <div class="input-field col s6 m6">
          <input id="start" type="datetime-local" class="" name="start">
          <label for="start" style="font-size: 12px; top: -25px;">Start time</label>
        </div>
        <div class="input-field col s6 m6">
        <input id="end" type="datetime-local" class="" name="end">
          <label for="end" style="font-size: 12px; top: -25px;">End time</label>
        </div>
      <div class="row">
        <div class="input-field col s6 m6">
          <input readonly type="text" id="price" name="price" value="<?php echo $_SESSION['locker_price']; ?>">
          <label for="price">Locker Price (LKR) / day</label>
        </div>
